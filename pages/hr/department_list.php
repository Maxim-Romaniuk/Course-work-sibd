...
<div class="wrapper">
    ...
    <section class="main-content">
        ...
        <table id="spec-table">
            <tr> <th width="100px">ID</th> <th width="650px">Название отдела</th> <th>Редактировать</th></tr>
            <?php
            while($dep=mysqli_fetch_assoc($result)){ ?>
                <tr> <td width="100px"><?= $dep['department_id']?></td> <td width="650px"><?= $dep['department_name']?></td> <td><a href="edit_department.php?id=<?=$dep['department_id']?>">Редактировать</a></td></tr>
                <?php
            }
            ?>
        </table>
